 ...
 */
@Entity
@Table(name = "vs_app_VacanteInteresadoEn")
@NamedQueries({
    @NamedQuery(name = "VsappVacanteInteresadoEn.findAll", query = "SELECT v FROM VsappVacanteInteresadoEn v")})
public class VsappVacanteInteresadoEn implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof VsappVacanteInteresadoEn)) {
            return false;
        }
        VsappVacanteInteresadoEn other = (VsappVacanteInteresadoEn) object;
    ...
    public String toString() {
        return "com.ec.entidad.VsappVacanteInteresadoEn[ idVacante=" + idVacante + " ]";
    }
