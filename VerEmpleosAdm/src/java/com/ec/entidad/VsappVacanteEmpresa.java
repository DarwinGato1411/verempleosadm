 ...
 */
@Entity
@Table(name = "vs_app_VacanteEmpresa")
@NamedQueries({
    @NamedQuery(name = "VsappVacanteEmpresa.findAll", query = "SELECT v FROM VsappVacanteEmpresa v")})
public class VsappVacanteEmpresa implements Serializable {
